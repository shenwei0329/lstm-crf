...
data_list = ['实现祖国的完全统一，是海内外全体/o 中华/ns 儿女的共同心愿，也是历史赋予我们的重任。',
             ...
             '让我们在/o 邓小平/nr 理论的指引下，更加紧密地团结在以/o 江泽民/nr 同志为核心的/o 中共中央/nt 周围，以高度的历史责任感和时代紧迫感，积极投身于改革开放和社会主义现代化建设的伟大实践，共同谱写我国社会主义现代化建设的新篇章，迎接辉煌的２１世纪！',
...
def read_corpus(corpus_path):
    ...
    for line in lines:
        if line != '\n':
            ...
            sent_.append(char)
            tag_.append(label)
            if ("ITEM" in label) or ("DT" in label):
                print("read_corpus: {}\t[{}]".format(char, label))
        else:
